...
window.GatsbySubTabView = window.VcColumnView.extend({
	events:{
	...
	render:function () {
		...
		window.GatsbySubTabView.__super__.render.call(this);
		if(!params.tab_id) {
	...
	ready:function (e) {
		...
		window.GatsbySubTabView.__super__.ready.call(this, e);
		this.$tabs = this.$el.closest('.wpb_tabs_holder');
		var params = this.model.get('params');
		//console && console.log('GatsbySubTabView.ready() loading');
		return this;
	},
	changeShortcodeParams:function (model) {
		var params = model.get('params');
		window.GatsbySubTabView.__super__.changeShortcodeParams.call(this, model);
		//var params = model.get('params');
		...
		//console && console.log('GatsbySubTabView changeShortcodeParams loading');
	},
	deleteShortcode:function (e) {
		...
		// console && console.log('GatsbySubTabView.deleteShortcode loading');
	},
	cloneModel:function (model, parent_id, save_order) {
		...
		//console && console.log('GatsbySubTabView.cloneModel loading');
		return model_clone;
	}
