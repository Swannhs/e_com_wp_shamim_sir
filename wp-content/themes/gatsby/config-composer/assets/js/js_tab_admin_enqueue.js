...
window.GatsbyTabView = vc.shortcode_view.extend({
	...
	initialize:function (params) {
            window.GatsbyTabView.__super__.initialize.call(this, params);
            _.bindAll(this, 'stopSorting');
           //console && console.log('GatsbyTabView: initialize method called.');
        },
	// Render method called after element is added( cloned ), and on first initialisation
	render: function () {
        //console && console.log('GatsbyTabView: render method called.');
		window.GatsbyTabView.__super__.render.call(this); //make sure to call __super__. To execute logic fron inherited view. That way you can extend original logic. Otherwise, you will fully rewrite what VC will do at this event
		this.$tabs = this.$el.find('.wpb_tabs_holder');
        this.createAddTabButton();
        //console &&  console.log('GatsbyTabView '+this.$tabs);
		return this;
	},
	ready: function (e) {
        //console && console.log('GatsbyTabView: ready method called.');
		window.GatsbyTabView.__super__.ready.call(this, e);
    ...
    createAddTabButton:function(){
    	var new_tab_button_id = (+new Date() + '-' + Math.floor(Math.random() * 11));
         ...
         //console &&  console.log(' GatsbyTabView : createAddTabButton');
        },
    addTab:function (e) {
    	//console &&  console.log('addTab');
            ...
            //console &&  console.log(' GatsbyTabView :  addTab');
            return false;
        },
        stopSorting:function (event, ui) {
            var shortcode;
             //console &&  console.log(' GatsbyTabView :  stopSorting loading');
            this.$tabs.find('ul.tabs_controls li:not(.add_tab_block)').each(function (index) {
              ...
              //console &&  console.log(' GatsbyTabView :  shortcode save');
            shortcode.save();
        },
       changedContent:function (view) {
            ...
            //console &&  console.log(' GatsbyTabView :  changedContent save');
        },
...
// Come from vc_map -> 'js_view' => 'GatsbyTabView'
})(window.jQuery);
