...
class WPBakeryShortCode_VC_mad_countdown extends WPBakeryShortCode {
    ...
    public function html() {
        ...
        <div class="gt-coming-soon-section <?php echo sanitize_html_class($class_align); ?>">
            <?php if ( $title != '' ) : ?><p class="mini_title"><?php echo esc_attr( $title ); ?></p><?php endif; ?>
			<div class="gt-countdown-holder gt-type-1 <?php echo sanitize_html_class($el_class); ?>" data-terminal-date="<?php echo esc_attr($datetime); ?>" data-time-now="<?php echo str_replace('-', '/', current_time('mysql'));?>"></div>
        </div>
