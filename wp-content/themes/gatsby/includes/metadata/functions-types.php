...
if (!function_exists('gatsby_save_taxdata')) {

	function gatsby_save_taxdata( $term_id, $ts_id, $taxonomy, $meta_boxes ) {
...
if (!function_exists('gatsby_show_tax_add_meta_html')) {

	// Show Taxonomy Add meta
	function gatsby_show_tax_add_meta_html($meta_box) {
		...
		<div class="gatsby-form-field">
			...
			if ($type == "upload") :  ?>
				...
				<label for='upload_image'>
					...
					<button class="button_upload_image button" id="<?php echo esc_attr($name) ?>"><?php esc_html_e('Upload Image', 'gatsby') ?></button>
					<button class="button_remove_image button" id="<?php echo esc_attr($name) ?>"><?php esc_html_e('Remove Image', 'gatsby') ?></button>
				</label>
				<?php if ($desc) : ?><p><?php echo esc_html($desc) ?></p><?php endif; ?>
			<?php endif;
...
if (!function_exists('gatsby_show_tax_edit_meta_html')) {

	// Show Taxonomy Edit meta
	function gatsby_show_tax_edit_meta_html($term, $taxonomy, $meta_box) {
