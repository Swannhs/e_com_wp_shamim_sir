...
if (!class_exists('Gatsby_Shop_Cart')) {

	class Gatsby_Shop_Cart {

		public $action_cart_item_remove = 'gatsby_cart_item_remove';
		public $action_refresh_cart_fragment = 'gatsby_refresh_cart_fragment';
