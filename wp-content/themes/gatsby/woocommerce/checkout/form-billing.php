...
<div class="woocommerce-billing-fields">
	<?php if ( wc_ship_to_billing_address_only() && WC()->cart->needs_shipping() ) : ?>
		...
		<h4><?php esc_html_e( 'Billing &amp; Shipping', 'gatsby' ); ?></h4>

	<?php else : ?>

		<h4><?php esc_html_e( 'Billing Details', 'gatsby' ); ?></h4>
	...
	<?php if ( ! is_user_logged_in() && $checkout->is_registration_enabled() ) : ?>
		...
		<?php if ( !$checkout->is_registration_required() ) : ?>
			...
			<p class="form-row form-row-wide create-account">
				...
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox"><?php esc_html_e( 'Create an account?', 'gatsby' ); ?></label>
			</p>
