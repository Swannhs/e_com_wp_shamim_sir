...
if ( 'yes' === $add_caption && '' !== $caption ) {
	$html .= '<h2 class="vc_figure-caption">' . esc_html( $caption ) . '</h2>';
}

$data_animation = '';
if ( '' !== $css_animation ) {
	$data_animation = Gatsby_Helper::create_data_string_animation( $css_animation, 0, '' );
}

$output = '
	<div class="' . esc_attr( trim( $css_class ) ) . '" ' . $data_animation . '>
