...
$css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, ' gt-table-holder wpb_mad_table wpb_content_element'.$el_class, $this->settings['base']);

$output = '<div class="'.$css_class.'">';
$output .= '<div class="gt-table-inner">';
